...
class Menu:
    ...
    def Main(username,Mode):
        ...
        folder = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Transfer", "Folder", "None").format(Font.Color.GREEN + username + Font.Color.WHITE)  + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if folder == 1:
            fold = "Usernames"
            secondFold = "True"
        elif folder == 2:
        ...
        if secondFold != "Exception":
            option = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Transfer", "Type", "None") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
            if option == 1:
                report = Report + ".txt"
                extension = ".txt"
                name = name2
