...
class Web:
    ...
    def Profiles(username,report):
        ...
        print("-------------------------------------------------------------------------------------------------------------------------------------")
        choice = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Robots") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
            Web.Robots(username, report)
        else:
            choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Ports") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
                Web.Ports(username, report)
            else:
                choice = int(input(
                    Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Traceroute") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
    ...
    def Reputation(username, report):
        ...
        sc = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Default", "choice", "None") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if sc == 1:
    ...
    def google_dork(username, number, num, email, email2):
        ...
        choice = int(input(
            Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Repu") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
    ...
    def search(username, Mode):
        ...
        choice = int(input(
            Font.Color.BLUE + " \n[+]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Whois") + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
