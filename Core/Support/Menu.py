...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN 
              +
              Font.Color.WHITE + "| A COMPLETE OSINT TOOL:      " + Font.Color.BANNER + "White hands Only" + Font.Color.RESET + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|   " + Font.Color.GREEN  +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "                    |")
        # print(
