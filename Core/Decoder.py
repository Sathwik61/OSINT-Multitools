...
class Menu:
    ...
    def Main(username,Mode):
        ...
        folder = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Folder", "None").format(Font.Color.GREEN + username + Font.Color.WHITE)  + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if folder == 1:
            fold = "Usernames"
            secondFold = "True"
        elif folder == 2:
        ...
        if folder == 1 or folder == 4:
            choice = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Type", "None").format(username)  + Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        ...
        option = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Options", "None")+ Font.Color.GREEN + "[#MP#]" + Font.Color.WHITE + "-->"))
        if option == 1:
            report = Report + ".txt" 
